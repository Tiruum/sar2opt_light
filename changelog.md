...
*   **`cfrwd-31`**: *Добавил EMA, добавил выходы cfr и hfcf веток на картинки, incenceNorm -> spectral_norm только в дискриминаторе*
    *   **Изменения:** Добавил EMA, добавил выходы cfr и hfcf веток на картинки, incenceNorm -> spectral_norm только в дискриминаторе
