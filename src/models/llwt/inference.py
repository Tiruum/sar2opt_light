"""Standalone inference entry for LLW-Former.
...
Mirrors ``src/models/sarformer_wb/inference.py``.
"""
import os
...
USE_LIVE_WEIGHTS = False   # set True to load pre-EMA (current_model_state)


def main():
    cfg = OmegaConf.load('./src/models/llwt/config.yaml')
