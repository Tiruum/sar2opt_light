...
Run from repo root::
    ...
    python -m src.models.llwt_v45_base.best_inference
"""
...
from src.models.llwt_v45_base.gen import LLWv4Generator


CHECKPOINT       = "checkpoints/llwt_v45_base/llwt-v0.4.6-base/last.ckpt"
TOP_K            = 3
SPLIT            = "val"          # "val" or "train"
METRIC           = "ssim"         # "psnr" | "ssim" | "lpips" — score used to rank
OUTPUT_DIR       = f"./src/models/llwt_v45_base/output/best_{SPLIT}"
...
def main():
    cfg = OmegaConf.load('./src/models/llwt_v45_base/config.yaml')
