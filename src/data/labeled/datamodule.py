...
from src.data.labeled.dataset import SARToOpticalDataset
...
class SAR2OPTDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str,
        batch_size: int,
        ...
        self.train_common_transform = get_common_transform()
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        full_dataset = SARToOpticalDataset(
